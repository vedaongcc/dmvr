...
for vid_file, split in zip(vid_file_lst, split_lst):
    ...
    with open(vid_file) as f:
        ...
        for line in lines:
            ...
            if (
                os.path.exists(vid_prefix + ".mp4")
                or os.path.exists(vid_prefix + ".mkv")
                or os.path.exists(vid_prefix + ".webm")
            ):
